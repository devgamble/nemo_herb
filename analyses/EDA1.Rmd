...
```{r echo = FALSE}
#ggplot(data = nemo_all1, aes(x = elev_m, y = lat))+
  #geom_point()
...
YoC_df <- read_csv(here::here("climateNA", "all_cna", "YoC_Y_and_L1_raw.csv")) %>% 
  rename(year = YoC)

Norms_df <- read_csv(here::here("climateNA", "all_CNA", "norms_raw_51_and_81.csv")) %>% 
  rename(year = YoC)
