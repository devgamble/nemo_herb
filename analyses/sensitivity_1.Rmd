...
visreg(an_full_clim4, "MAP_A", xlab = "CAP (Anomaly)", points = list(col = "#333333"), gg = TRUE) + theme_apa() +
  geom_vline(xintercept = 0, lty = 2)
ggsave(here::here("analyses", "figs1", "MAP_A_phensen.png"), height = 4, width = 6)
...
visreg(an_full_clim4, "MAP_100Y", xlab = "CAP (1901-2000)", points = list(col = "#333333"), gg = TRUE) + theme_apa() #reverse transform?
ggsave(here::here("analyses", "figs1", "MAP_100Y_phensen.png"), height = 4, width = 6)
