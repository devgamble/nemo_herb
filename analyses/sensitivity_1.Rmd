...
an_full_clim4 <- lm(DOY ~ MAT_100Y + MAP_100Y + MAT_A + MAP_A + elev_m + lat + long, data = nemo_df2) #Best, though adding year doesn't change much
#No interactions
...
#Anomalies
phens1 <- visreg(an_full_clim4, "MAT_A", xlab = "MAT (Anomaly)", points = list(col = "#333333"), gg = TRUE) + theme_apa() + geom_text(label = "βʹ = -3.71", x = Inf, y = Inf, hjust = 1.2, vjust = 1.3, size = 6) +
  geom_vline(xintercept = 0, lty = 2) + theme(text = element_text(size = 16), axis.title.y = element_text(size = 16), axis.title.x = element_text(size = 16))
#ggsave(here::here("analyses", "figs1", "MAT_A_phensen.png"), height = 4, width = 6)

phens2 <- visreg(an_full_clim4, "MAP_A", xlab = "CAP (Anomaly)", points = list(col = "#333333"), gg = TRUE) + theme_apa() + geom_text(label = "βʹ = 1.96", x = Inf, y = Inf, hjust = 1.2, vjust = 1.3, size = 6) +
  geom_vline(xintercept = 0, lty = 2) + theme(text = element_text(size = 16), axis.title.y = element_text(size = 16), axis.title.x = element_text(size = 16))
#ggsave(here::here("analyses", "figs1", "MAP_A_phensen.png"), height = 4, width = 6)

#Norms
phens3 <- visreg(an_full_clim4, "MAT_100Y", xlab = "MAT (1901-2000)", points = list(col = "#333333"), gg = TRUE) + theme_apa() + geom_text(label = "βʹ = -3.89", x = Inf, y = Inf, hjust = 1.2, vjust = 1.3, size = 6) + theme(text = element_text(size = 16), axis.title.y = element_text(size = 16), axis.title.x = element_text(size = 16))
#ggsave(here::here("analyses", "figs1", "MAT_100Y_phensen.png"), height = 4, width = 6)

phens4 <- visreg(an_full_clim4, "MAP_100Y", xlab = "CAP (1901-2000)", points = list(col = "#333333"), gg = TRUE) + theme_apa() + geom_text(label = "βʹ = 7.46", x = Inf, y = Inf, hjust = 1.2, vjust = 1.3, size = 6) + theme(text = element_text(size = 16), axis.title.y = element_text(size = 16), axis.title.x = element_text(size = 16))
#ggsave(here::here("analyses", "figs1", "MAP_100Y_phensen.png"), height = 4, width = 6)


##Combine into a single ggplot figure

ggarrange(phens3, phens4, phens1, phens2, ncol = 2, nrow = 2, labels = c("(a)", "(b)", "(c)", "(d)"), font.label = list(size = 18), vjust = 2, hjust = -2.4)
#removed: labels = c("(a)", "(b)", "(c)", "(d)"

ggsave(here::here("analyses", "figs1", "phensen_MAT_CAP_100&A.png"), width = 12, height = 8)
...
#Ave T - higher VIFs fo TAve_100Y (> 5) -- possibility from colinaerity with lat/long...?
...
summ(sz_sp1c, vifs = TRUE) #not scaled
summ(sz_sp1c, scale = TRUE, vifs = TRUE)


#Visualizations#
visreg(sz_sp1c, xvar = "PPT_sp_100Y", xlab = "Spring LOG-PPT (1901-2000)", points = list(col = "#333333"), gg = TRUE) + theme_apa()
...
#Visualizations#
visreg(sz_sp1c, xvar = "PPT_sp_100Y", xlab = "Spring PPT (1901-2000)", points = list(col = "#333333"), gg = TRUE) + theme_apa(x.font.size = 14, y.font.size = 14) + theme(axis.text.x = element_text(size = 14), axis.text.y = element_text(size = 14))
ggsave(here::here("analyses", "figs1", "spring_PPT100_phensenV2.png"), height = 4, width = 5)


#V2.5 - back-transform PPT
visreg(sz_sp1c, xvar = "PPT_sp_100Y", xtrans = exp, xlab = "Spring PPT (1901-2000)", points = list(col = "#333333"), gg = TRUE) + theme_apa(x.font.size = 14, y.font.size = 14) + theme(axis.text.x = element_text(size = 14), axis.text.y = element_text(size = 14))
ggsave(here::here("analyses", "figs1", "spring_PPT100_phensen_xtransexp.png"), height = 4, width = 5)


 visreg(sz_sp1c, xvar = "Tmin_sp_100Y", xlab = "Spring Tmin (1901-2000)", points = list(col = "#333333"),gg = TRUE) + theme_apa(x.font.size = 14, y.font.size = 14) + theme(axis.text.x = element_text(size = 14), axis.text.y = element_text(size = 14))
ggsave(here::here("analyses", "figs1", "spring_Tmin100_phensenV2.png"), height = 4, width = 5)

visreg(sz_sp1c, xvar = "PPT_sp_A", xlab = "Spring PPT (Anomaly)", points = list(col = "#333333"), gg = TRUE) + theme_apa(x.font.size = 14, y.font.size = 14) + theme(axis.text.x = element_text(size = 14), axis.text.y = element_text(size = 14)) + 
  geom_vline(xintercept = 0, lty = 2)
ggsave(here::here("analyses", "figs1", "spring_PPT_A_phensenV2.png"), height = 4, width = 5)

visreg(sz_sp1c, xvar = "Tmin_sp_A", xlab = "Spring Tmin (Anomaly)", points = list(col = "#333333"), gg = TRUE) + theme_apa(x.font.size = 14, y.font.size = 14) + theme(axis.text.x = element_text(size = 14), axis.text.y = element_text(size = 14)) +
  geom_vline(xintercept = 0, lty = 2)
