...
```{r MAT and MAP Anomalies, message = FALSE, warning = FALSE}
...
```
*NOTE*: Effect of year becomes nonsignificant when anomalous conditions are in model. Makes sense.  



```{r Corr-plot, message = FALSE, warning = FALSE}
#Corrplot for supp mat?
corrplot(cor(nemo_df2 %>% select(MAT_100Y, MAP_100Y, MAT_A, MAP_A, elev_m, long, lat, year)), method = "color", addCoef.col = "black", number.cex = .6,) #some autocorrelation in T anoms? elev*long corr
