...
#Just Climate
plot_summs(M100Y_lm2ALb, erc_an0ALb, erc_an1ALb, erc_an2ALb, model.names = c("All Records", "Records with Error", "Error < 5 km", "Error < 2 km"), coefs = c("MAT (100Y)" =  "MAT_100Y", "CAP (100Y)" = "MAP_100Y", "MAT (Anom.)" =  "MAT_A", "CAP (Anom.)" = "MAP_A"), legend.title = "Model Data", scale = TRUE) + theme_bw() + scale_x_continuous(limits = c(-9, 10.5)) + labs(y = "Predictor")
