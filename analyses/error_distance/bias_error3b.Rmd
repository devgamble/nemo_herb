...
plot_summs(M100Y_lm1, M100Y_2klmR1, M100Y_5klmR1, M100Y_15klmR1, M100Y_25klmR1, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
...
plot_summs(M100Y_lm1c, M100Y_2klmR1c, M100Y_5klmR1c, M100Y_15klmR1c, M100Y_25klmR1c, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), coefs = c("MAT_100Y" = "MAT_100Y", "MAP_100Y" = "MAP_100Y"), legend.title = "Model Data", scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
...
plot_summs(MA_lm1, MA_2klmR1, MA_5klmR1, MA_15klmR1, MA_25klmR1, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
...
#Climate only diplayed
plot_summs(MA_lm1c, MA_2klmR1c, MA_5klmR1c, MA_15klmR1c, MA_25klmR1c, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), coefs = c("MAT_A" = "MAT_A", "MAP_A" = "MAP_A"), legend.title = "Model Data", scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
ggsave(here::here("analyses", "figs1", "errorD", "sims_MATMAP_A_r1.png"), width = 6, height = 4)


#All covariates
plot_summs(MA_lm1c, MA_2klmR1c, MA_5klmR1c, MA_15klmR1c, MA_25klmR1c, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
...
plot_summs(MLA_lm1, MLA_2klmR1, MLA_5klmR1, MLA_15klmR1, MLA_25klmR1, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)
...
##
plot_summs(MLA_lm1c, MLA_2klmR1c, MLA_5klmR1c, MLA_15klmR1c, MLA_25klmR1c, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), coefs = c("MAT (100Y)" = "MAT_100Y", "CAP (100Y)" = "MAP_100Y", "MAT (Anom.)" = "MAT_A", "CAP (Anom.)" = "MAP_A"), legend.title = "Model Data", scale = TRUE, colors = "Rainbow") + theme_bw() + labs(y = "Predictor")
...
#All covariates
plot_summs(MLA_lm1c, MLA_2klmR1c, MLA_5klmR1c, MLA_15klmR1c, MLA_25klmR1c, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)
```
...
#Climate only diplayed
plot_summs(M100Y_lm2, M100Y_2klmR2, M100Y_5klmR2, M100Y_15klmR2, M100Y_25klmR2, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), coefs = c("MAT_100Y" = "MAT_100Y", "MAP_100Y" = "MAP_100Y"), legend.title = "Model Data", scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)


#All covariates
plot_summs(M100Y_lm2, M100Y_2klmR2, M100Y_5klmR2, M100Y_15klmR2, M100Y_25klmR2, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)
...
#Climate only diplayed
plot_summs(MA_lm2, MA_2klmR2, MA_5klmR2, MA_15klmR2, MA_25klmR2, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), coefs = c("MAT_A" = "MAT_A", "MAP_A" = "MAP_A"), legend.title = "Model Data", scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)


#All covariates
plot_summs(MA_lm2, MA_2klmR2, MA_5klmR2, MA_15klmR2, MA_25klmR2, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)
```
...
#Climate only diplayed
plot_summs(MLA_lm2c, MLA_2klmR2c, MLA_5klmR2c, MLA_15klmR2c, MLA_25klmR2c, model.names = c("Original", "2 km sims", "5 km sims", "15 km sims", "25 km sims"), coefs = c("MAT (100Y)" = "MAT_100Y", "CAP (100Y)" = "MAP_100Y", "MAT (Anom.)" = "MAT_A", "CAP (Anom.)" = "MAP_A"), legend.title = "Model Data", scale = TRUE, colors = "Rainbow") + theme_bw() + labs(y = "Predictor")
...
#Climate only diplayed
plot_summs(M100Y_lm3, M100Y_2klmR3, M100Y_5klmR3, M100Y_15klmR3, M100Y_25klmR3, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), coefs = c("MAT_100Y" = "MAT_100Y", "MAP_100Y" = "MAP_100Y"), legend.title = "Model Data", scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)


#All covariates
plot_summs(M100Y_lm3, M100Y_2klmR3, M100Y_5klmR3, M100Y_15klmR3, M100Y_25klmR3, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)
...
#Climate only diplayed
plot_summs(MA_lm3, MA_2klmR3, MA_5klmR3, MA_15klmR3, MA_25klmR3, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), coefs = c("MAT_A" = "MAT_A", "MAP_A" = "MAP_A"), legend.title = "Model Data", scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)


#All covariates
plot_summs(MA_lm3, MA_2klmR3, MA_5klmR3, MA_15klmR3, MA_25klmR3, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)
```
...
#Climate only diplayed
plot_summs(MLA_lm3c, MLA_2klmR3c, MLA_5klmR3c, MLA_15klmR3c, MLA_25klmR3c, model.names = c("Original", "2 km sims", "5 km sims", "15 km sims", "25 km sims"), coefs = c("MAT (100Y)" = "MAT_100Y", "CAP (100Y)" = "MAP_100Y", "MAT (Anom.)" = "MAT_A", "CAP (Anom.)" = "MAP_A"), legend.title = "Model Data", scale = TRUE, colors = "Rainbow") + theme_bw() + labs(y = "Predictor")
...
#Climate only diplayed
plot_summs(M100Y_lm4, M100Y_2klmR4, M100Y_5klmR4, M100Y_15klmR4, M100Y_25klmR4, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), coefs = c("MAT_100Y" = "MAT_100Y", "MAP_100Y" = "MAP_100Y"), legend.title = "Model Data", scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)


#All covariates
plot_summs(M100Y_lm4, M100Y_2klmR4, M100Y_5klmR4, M100Y_15klmR4, M100Y_25klmR4, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)
...
#Climate only diplayed
plot_summs(MA_lm4, MA_2klmR4, MA_5klmR4, MA_15klmR4, MA_25klmR4, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), coefs = c("MAT_A" = "MAT_A", "MAP_A" = "MAP_A"), legend.title = "Model Data", scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)


#All covariates
plot_summs(MA_lm4, MA_2klmR4, MA_5klmR4, MA_15klmR4, MA_25klmR4, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)
```
...
#Climate only diplayed
plot_summs(MLA_lm4c, MLA_2klmR4c, MLA_5klmR4c, MLA_15klmR4c, MLA_25klmR4c, model.names = c("Original", "2 km sims", "5 km sims", "15 km sims", "25 km sims"), coefs = c("MAT (100Y)" = "MAT_100Y", "CAP (100Y)" = "MAP_100Y", "MAT (Anom.)" = "MAT_A", "CAP (Anom.)" = "MAP_A"), legend.title = "Model Data", scale = TRUE, colors = "Rainbow") + theme_bw() + labs(y = "Predictor")
...
#Climate only diplayed
plot_summs(M100Y_lm5, M100Y_2klmR5, M100Y_5klmR5, M100Y_15klmR5, M100Y_25klmR5, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), coefs = c("MAT_100Y" = "MAT_100Y", "MAP_100Y" = "MAP_100Y"), legend.title = "Model Data", scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)


#All covariates
plot_summs(M100Y_lm5, M100Y_2klmR5, M100Y_5klmR5, M100Y_15klmR5, M100Y_25klmR5, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)
...
#Climate only diplayed
plot_summs(MA_lm5, MA_2klmR5, MA_5klmR5, MA_15klmR5, MA_25klmR5, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), coefs = c("MAT_A" = "MAT_A", "MAP_A" = "MAP_A"), legend.title = "Model Data", scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)


#All covariates
plot_summs(MA_lm5, MA_2klmR5, MA_5klmR5, MA_15klmR5, MA_25klmR5, model.names = c("Original", "2 km sim.", "5 km sim.", "15 km sim.", "25 km sim."), scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)
```
...
#Climate only diplayed
plot_summs(MLA_lm5c, MLA_2klmR5c, MLA_5klmR5c, MLA_15klmR5c, MLA_25klmR5c, model.names = c("Original", "2 km sims", "5 km sims", "15 km sims", "25 km sims"), coefs = c("MAT (100Y)" = "MAT_100Y", "CAP (100Y)" = "MAP_100Y", "MAT (Anom.)" = "MAT_A", "CAP (Anom.)" = "MAP_A"), legend.title = "Model Data", scale = TRUE, colors = "Rainbow") + theme_bw() + labs(y = "Predictor")
...
ggplot(data = param_change) + 
  ...
  scale_x_discrete(labels = c("MAT-100", "CAP-100", "MAT-A", "CAP-A")) +
  facet_wrap(~contrast) +
  theme_bw()
...
ggplot(data = param_change) + 
  ...
  scale_x_discrete(labels = c("MAT (100Y)", "CAP (100Y)", "MAT (A)", "CAP (A)")) +
...
OGsds <- tibble(.rows = 5) %>% 
  mutate(contrast = rep("Original", 5), param = c("elev", "MAT_100Y", "MAP_100Y", "MAT_A", "MAP_A"), var_sd =         
...
enviro_change2 = rbind(enviro_change, OGsds) %>% 
  mutate(contrast = factor(contrast, levels = c("Original", "2 km", "5 km", "15 km", "25 km"), ordered = TRUE))
...
ggsave(here::here("analyses", "figs1", "errorD", "sims_SD_elev_m.png"), width = 6, height = 4)
