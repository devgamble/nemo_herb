...
```{r AVG1, message = FALSE, eval = FALSE}
## Long-term Climate

#With Covariates
M100Y_lm1c <- lm(DOY ~ MAT_100Y + MAP_100Y  + elev_m + long + year, data = nemo_e2)

M100Y_2klmRAVGc <- lm(DOY ~ MAT_100Y + MAP_100Y + elev_m + long + year, data = nemo_2ksim_avg)
M100Y_5klmRAVGc <- lm(DOY ~ MAT_100Y + MAP_100Y + elev_m + long + year, data = nemo_5ksim_avg)
M100Y_15klmRAVGc <- lm(DOY ~ MAT_100Y + MAP_100Y + elev_m + long + year, data = nemo_15ksim_avg)
M100Y_25klmRAVGc <- lm(DOY ~ MAT_100Y + MAP_100Y + elev_m + long + year, data = nemo_25ksim_avg)

#Adj Rsq
mod.list <- list(M100Y_lm1c, M100Y_2klmRAVGc, M100Y_5klmRAVGc, M100Y_15klmRAVGc, M100Y_25klmRAVGc)
sapply(mod.list, adjrsq)

#Climate only diplayed
plot_summs(M100Y_lm1c, M100Y_2klmRAVGc, M100Y_5klmRAVGc, M100Y_15klmRAVGc, M100Y_25klmRAVGc, model.names = c("Original (0-2km error)", "2km sims", "5km sims", "15km sims", "25km  sims"), coefs = c("MAT_100Y" = "MAT_100Y", "MAP_100Y" = "MAP_100Y"), legend.title = "Model Data", scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)


#All covariates
plot_summs(M100Y_lm1c, M100Y_2klmRAVGc, M100Y_5klmRAVGc, M100Y_15klmRAVGc, M100Y_25klmRAVGc, model.names = c("Original (0-2km error)", "2km sims", "5km sims", "15km sims", "25km  sims"), scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)
```

```{r AVG2, message = FALSE, eval = FALSE}
##Anomalies

MA_lm1c <- lm(DOY ~ MAT_A + MAP_A  + elev_m + long + year, data = nemo_e2)

MA_2klmRAVGc <- lm(DOY ~ MAT_A + MAP_A + elev_m + long + year, data = nemo_2ksim_avg)
MA_5klmRAVGc <- lm(DOY ~ MAT_A + MAP_A + elev_m + long + year, data = nemo_5ksim_avg)
MA_15klmRAVGc <- lm(DOY ~ MAT_A + MAP_A + elev_m + long + year, data = nemo_15ksim_avg)
MA_25klmRAVGc <- lm(DOY ~ MAT_A + MAP_A + elev_m + long + year, data = nemo_25ksim_avg)

#Adj Rsq
mod.list <- list(MA_lm1c, MA_2klmRAVGc, MA_5klmRAVGc, MA_15klmRAVGc, MA_25klmRAVGc)
sapply(mod.list, adjrsq)

#Climate only diplayed
plot_summs(MA_lm1c, MA_2klmRAVGc, MA_5klmRAVGc, MA_15klmRAVGc, MA_25klmRAVGc, model.names = c("Original (0-2km error)", "2km sims", "5km sims", "15km sims", "25km  sims"), coefs = c("MAT_A" = "MAT_A", "MAP_A" = "MAP_A"), legend.title = "Model Data", scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)


#All covariates
plot_summs(MA_lm1c, MA_2klmRAVGc, MA_5klmRAVGc, MA_15klmRAVGc, MA_25klmRAVGc, model.names = c("Original (0-2km error)", "2km sims", "5km sims", "15km sims", "25km  sims"), scale = TRUE) + theme_bw() #+ scale_x_continuous(limits = c(-15, 10))
#ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP1.png"), width = 6, height = 4)
```

```{r AVG3, message = FALSE}
### 
# Long-term & Anomalies 
###
...
### Include sim distance as a covariate?!?!?  NO.
