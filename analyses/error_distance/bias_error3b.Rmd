...
lapply((sims_2kma %>% filter(replicate == "rep1") %>% select(elev_change:MAP_A_change)), FUN = hist)
lapply((sims_5kma %>% filter(replicate == "rep1") %>% select(elev_change:MAP_A_change)), FUN = hist)
lapply((sims_15kma %>% filter(replicate == "rep1") %>% select(elev_change:MAP_A_change)), FUN = hist)
lapply((sims_25kma %>% filter(replicate == "rep1") %>% select(elev_change:MAP_A_change)), FUN = hist)
...
#Use other measure of variance???

#SD
lapply(X = c((sims_2kma %>% filter(replicate == "rep1") %>% select(elev_change)), (sims_5kma %>% filter(replicate == "rep1") %>% select(elev_change)), (sims_15kma %>% filter(replicate == "rep1") %>% select(elev_change)), (sims_25kma %>% filter(replicate == "rep1") %>% select(elev_change))), FUN = sd)
...
#Rep 2
lapply((sims_2kma %>% filter(replicate == "rep2") %>% select(elev_change:MAP_A_change)), FUN = hist)
lapply((sims_5kma %>% filter(replicate == "rep2") %>% select(elev_change:MAP_A_change)), FUN = hist)
lapply((sims_15kma %>% filter(replicate == "rep2") %>% select(elev_change:MAP_A_change)), FUN = hist)
lapply((sims_25kma %>% filter(replicate == "rep2") %>% select(elev_change:MAP_A_change)), FUN = hist)


#Variance
lapply(X = c((sims_2kma %>% filter(replicate == "rep2") %>% select(elev_change)), (sims_5kma %>% filter(replicate == "rep2") %>% select(elev_change)), (sims_15kma %>% filter(replicate == "rep2") %>% select(elev_change)), (sims_25kma %>% filter(replicate == "rep2") %>% select(elev_change))), FUN = var)


#SD
lapply(X = c((sims_2kma %>% filter(replicate == "rep2") %>% select(elev_change)), (sims_5kma %>% filter(replicate == "rep2") %>% select(elev_change)), (sims_15kma %>% filter(replicate == "rep2") %>% select(elev_change)), (sims_25kma %>% filter(replicate == "rep2") %>% select(elev_change))), FUN = sd)



#Rep 3
lapply((sims_2kma %>% filter(replicate == "rep3") %>% select(elev_change:MAP_A_change)), FUN = hist)
lapply((sims_5kma %>% filter(replicate == "rep3") %>% select(elev_change:MAP_A_change)), FUN = hist)
lapply((sims_15kma %>% filter(replicate == "rep3") %>% select(elev_change:MAP_A_change)), FUN = hist)
lapply((sims_25kma %>% filter(replicate == "rep3") %>% select(elev_change:MAP_A_change)), FUN = hist)


#Variance
lapply(X = c((sims_2kma %>% filter(replicate == "rep3") %>% select(elev_change)), (sims_5kma %>% filter(replicate == "rep3") %>% select(elev_change)), (sims_15kma %>% filter(replicate == "rep3") %>% select(elev_change)), (sims_25kma %>% filter(replicate == "rep3") %>% select(elev_change))), FUN = var)


#SD
lapply(X = c((sims_2kma %>% filter(replicate == "rep3") %>% select(elev_change)), (sims_5kma %>% filter(replicate == "rep3") %>% select(elev_change)), (sims_15kma %>% filter(replicate == "rep3") %>% select(elev_change)), (sims_25kma %>% filter(replicate == "rep3") %>% select(elev_change))), FUN = sd)



#Rep 4
lapply((sims_2kma %>% filter(replicate == "rep4") %>% select(elev_change:MAP_A_change)), FUN = hist)
lapply((sims_5kma %>% filter(replicate == "rep4") %>% select(elev_change:MAP_A_change)), FUN = hist)
lapply((sims_15kma %>% filter(replicate == "rep4") %>% select(elev_change:MAP_A_change)), FUN = hist)
lapply((sims_25kma %>% filter(replicate == "rep4") %>% select(elev_change:MAP_A_change)), FUN = hist)


#Variance
lapply(X = c((sims_2kma %>% filter(replicate == "rep4") %>% select(elev_change)), (sims_5kma %>% filter(replicate == "rep4") %>% select(elev_change)), (sims_15kma %>% filter(replicate == "rep4") %>% select(elev_change)), (sims_25kma %>% filter(replicate == "rep4") %>% select(elev_change))), FUN = var)


#SD
lapply(X = c((sims_2kma %>% filter(replicate == "rep4") %>% select(elev_change)), (sims_5kma %>% filter(replicate == "rep4") %>% select(elev_change)), (sims_15kma %>% filter(replicate == "rep4") %>% select(elev_change)), (sims_25kma %>% filter(replicate == "rep4") %>% select(elev_change))), FUN = sd)


#Rep 5
lapply((sims_2kma %>% filter(replicate == "rep5") %>% select(elev_change:MAP_A_change)), FUN = hist)
lapply((sims_5kma %>% filter(replicate == "rep5") %>% select(elev_change:MAP_A_change)), FUN = hist)
lapply((sims_15kma %>% filter(replicate == "rep5") %>% select(elev_change:MAP_A_change)), FUN = hist)
lapply((sims_25kma %>% filter(replicate == "rep5") %>% select(elev_change:MAP_A_change)), FUN = hist)


#Variance
lapply(X = c((sims_2kma %>% filter(replicate == "rep5") %>% select(elev_change)), (sims_5kma %>% filter(replicate == "rep5") %>% select(elev_change)), (sims_15kma %>% filter(replicate == "rep5") %>% select(elev_change)), (sims_25kma %>% filter(replicate == "rep5") %>% select(elev_change))), FUN = var)


#SD
lapply(X = c((sims_2kma %>% filter(replicate == "rep5") %>% select(elev_change)), (sims_5kma %>% filter(replicate == "rep5") %>% select(elev_change)), (sims_15kma %>% filter(replicate == "rep5") %>% select(elev_change)), (sims_25kma %>% filter(replicate == "rep5") %>% select(elev_change))), FUN = sd)



#Other change variables (climate)
#Variance
lapply(X = c((sims_2kma %>% filter(replicate == "rep5") %>% select(MAT_100Y_change)), (sims_5kma %>% filter(replicate == "rep5") %>% select(MAT_100Y_change)), (sims_15kma %>% filter(replicate == "rep5") %>% select(MAT_100Y_change)), (sims_25kma %>% filter(replicate == "rep5") %>% select(MAT_100Y_change))), FUN = var)


#Variance
lapply(X = c((sims_2kma %>% filter(replicate == "rep5") %>% select(MAP_100Y_change)), (sims_5kma %>% filter(replicate == "rep5") %>% select(MAP_100Y_change)), (sims_15kma %>% filter(replicate == "rep5") %>% select(MAP_100Y_change)), (sims_25kma %>% filter(replicate == "rep5") %>% select(MAP_100Y_change))), FUN = var)


#Variance
lapply(X = c((sims_2kma %>% filter(replicate == "rep5") %>% select(MAT_A_change)), (sims_5kma %>% filter(replicate == "rep5") %>% select(MAT_A_change)), (sims_15kma %>% filter(replicate == "rep5") %>% select(MAT_A_change)), (sims_25kma %>% filter(replicate == "rep5") %>% select(MAT_A_change))), FUN = var)


#Variance
lapply(X = c((sims_2kma %>% filter(replicate == "rep5") %>% select(MAP_A_change)), (sims_5kma %>% filter(replicate == "rep5") %>% select(MAP_A_change)), (sims_15kma %>% filter(replicate == "rep5") %>% select(MAP_A_change)), (sims_25kma %>% filter(replicate == "rep5") %>% select(MAP_A_change))), FUN = var)


#SD for anomaly change:

lapply(X = c((sims_2kma %>% filter(replicate == "rep5") %>% select(MAT_A_change)), (sims_5kma %>% filter(replicate == "rep5") %>% select(MAT_A_change)), (sims_15kma %>% filter(replicate == "rep5") %>% select(MAT_A_change)), (sims_25kma %>% filter(replicate == "rep5") %>% select(MAT_A_change))), FUN = sd)


lapply(X = c((sims_2kma %>% filter(replicate == "rep5") %>% select(MAP_A_change)), (sims_5kma %>% filter(replicate == "rep5") %>% select(MAP_A_change)), (sims_15kma %>% filter(replicate == "rep5") %>% select(MAP_A_change)), (sims_25kma %>% filter(replicate == "rep5") %>% select(MAP_A_change))), FUN = sd)

#Coeff_var gives weird estimates that don't follow the trend of variance or sd...

```

Generally, variance and SD increase with increasing simulated distances, indicating a greater amount of variability in new coordinates' elevation, long-term AND anomalous climate conditions!
...
Conclusion: *Do not include `elev_change` and `MAT/MAP_100Y_change` in the same model!* It's reasonable here to assume that changes in elevation serve as a decent proxy for changes in long-term, chronic climatic conditions.
...
## Run Models with change variables as covariates  
...
#Just elev change
lmsim_change_1a <- lm(DOY ~ MAT_100Y + MAP_100Y + MAT_A + MAP_A + elev_m + long + year + elev_change, data = filter(sims_2kma, replicate == "rep1"))
summ(lmsim_change_1a, scale = TRUE, vif = TRUE)

#Followed by elev_change & MAT/P_A_change
lmsim_change_1b <- lm(DOY ~ MAT_100Y + MAP_100Y + MAT_A + MAP_A + elev_m + long + year + elev_change + MAT_A_change + MAP_A_change, data = filter(sims_2kma, replicate == "rep1"))
summ(lmsim_change_1b, scale = TRUE, vif = TRUE) #collinearity with long may be problematic


#5km
lmsim_change_2a <- lm(DOY ~ MAT_100Y + MAP_100Y + MAT_A + MAP_A + elev_m + long + year + elev_change, data = filter(sims_5kma, replicate == "rep1"))
summ(lmsim_change_2a, scale = TRUE, vif = TRUE)

lmsim_change_2b <- lm(DOY ~ MAT_100Y + MAP_100Y + MAT_A + MAP_A + elev_m + long + year + elev_change + MAT_A_change + MAP_A_change, data = filter(sims_5kma, replicate == "rep1"))
summ(lmsim_change_2b, scale = TRUE, vif = TRUE) 


#15km
lmsim_change_3a <- lm(DOY ~ MAT_100Y + MAP_100Y + MAT_A + MAP_A + elev_m + long + year + elev_change, data = filter(sims_15kma, replicate == "rep1"))
summ(lmsim_change_3a, scale = TRUE, vif = TRUE)

lmsim_change_3b <- lm(DOY ~ MAT_100Y + MAP_100Y + MAT_A + MAP_A + elev_m + long + year + elev_change + MAT_A_change + MAP_A_change, data = filter(sims_15kma, replicate == "rep1"))
...
#25km 
lmsim_change_4a <- lm(DOY ~ MAT_100Y + MAP_100Y + MAT_A + MAP_A + elev_m + long + year + elev_change, data = filter(sims_25kma, replicate == "rep1"))
summ(lmsim_change_4a, scale = TRUE, vif = TRUE)

lmsim_change_4b <- lm(DOY ~ MAT_100Y + MAP_100Y + MAT_A + MAP_A + elev_m + long + year + elev_change + MAT_A_change + MAP_A_change, data = filter(sims_25kma, replicate == "rep1"))
...
MLA_2klmRAVGc <- lm(DOY ~ MAT_100Y + MAP_100Y + MAT_A + MAP_A + elev_m + long + year, data = nemo_2ksim_avg)
MLA_5klmRAVGc <- lm(DOY ~ MAT_100Y + MAP_100Y + MAT_A + MAP_A + elev_m + long + year, data = nemo_5ksim_avg)
MLA_15klmRAVGc <- lm(DOY ~ MAT_100Y + MAP_100Y + MAT_A + MAP_A + elev_m + long + year, data = nemo_15ksim_avg)
MLA_25klmRAVGc <- lm(DOY ~ MAT_100Y + MAP_100Y + MAT_A + MAP_A + elev_m + long + year, data = nemo_25ksim_avg)
