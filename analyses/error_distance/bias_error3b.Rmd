...
param_change[1:16,2] <- rep(c("2k", "5k", "15k", "25k"), 4)
...
param_change$contrast <- factor(param_change$contrast, levels = c("2k", "5k", "15k", "25k"), ordered = TRUE)
...
ggplot(data = param_change) + 
  geom_col(aes(x = param, y = coef_dif, fill = contrast)) + 
  geom_hline(yintercept = 0, lty = 2) + #for non-abs values
  facet_wrap(~contrast) +
  theme_bw()

ggplot(data = param_change) + 
  geom_col(aes(x = param, y = abs_SE_dif, fill = contrast)) +
  #geom_hline(yintercept = 0, lty = 2) +
  facet_wrap(~contrast) +
  theme_bw()

ggplot(data = param_change) + 
  geom_col(aes(x = contrast, y = R2_dif)) +
  theme_bw()
#Positive values, indicating how much the R2 value decreased
