...
```{r eval = FALSE}
lmsim_change_1a <- lm(DOY ~ MAT_100Y + MAP_100Y + MAT_A*elev_change + MAP_A*elev_change + lat + long + year, data = filter(sims_25kma, replicate == "rep1"))
...
```{r}
lmsim_change_c_1 <- lm(DOY ~ MAT_100Y + MAP_100Y + MAT_A*elev_change + MAP_A*elev_change + lat + long + year + data_origin, data = filter(nemo_combinedsims2, replicate == "rep1")) #controls for data_origin
summ(lmsim_change_c_1, scale = TRUE, vif = TRUE)
#NS

lmsim_change_c_1 <- lm(DOY ~ MAT_100Y + MAP_100Y + MAT_A*MAT_100Y_change + MAP_A*MAT_100Y_change + lat + long + year + data_origin, data = filter(nemo_combinedsims2, replicate == "rep1")) #controls for data_origin
summ(lmsim_change_c_1, scale = TRUE, vif = TRUE)
#NS

lmsim_change_c_1 <- lm(DOY ~ MAT_100Y + MAP_100Y + MAT_A*MAT_A_change + MAP_A*MAT_A_change + lat + long + year + data_origin, data = filter(nemo_combinedsims2, replicate == "rep1")) #controls for data_origin
summ(lmsim_change_c_1, scale = TRUE, vif = TRUE)
#NS
