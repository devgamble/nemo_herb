...
ggplot(data = param_change) + 
  geom_col(aes(x = param, y = abs_SE_dif, fill = contrast), col = "black") +
  scale_x_discrete(labels = c("MAT-100", "MAP-100", "MAT-A", "MAP-A")) +
  #geom_hline(yintercept = 0, lty = 2) +
  facet_wrap(~contrast) +
  labs(fill = "Simulated Displacement") +
  theme_bw()
...
ggplot(data = param_R2change) + 
  geom_col(aes(x = contrast, y = R2_dif, fill = contrast), col = "black") +
  labs(y = "R2 Change") +
  theme_bw()
...
#Histograms for change in each of the above variables - all centered around 0, as expected
