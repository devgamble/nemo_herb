...
summ(lmsim_change_1_c, scale = TRUE, vif = TRUE)
#NS
```
...
Potential work-around: average (separately) coefficient estimates, SEs, SD estimates for predictor variables for all replicates from a full data table...
