...
ggplot(data = param_change) + 
  ...
  scale_x_discrete(labels = c("MAT (100Y)", "MAP (100Y)", "MAT (Anom.)", "MAP (Anom.)")) +
  scale_y_continuous(expand = c(0.02,0)) +
  scale_fill_manual(values = c("#447CBF", "#83BA6D", "#DBAB3B", "#D92120")) +
  geom_hline(yintercept = 0, lty = 1) +
  #facet_wrap(~contrast) +
  labs(fill = "Simulated Data", y = "Change in Estimate SE", x = "Parameter") +
  theme_classic()
ggsave(here::here("analyses", "figs1", "errorD", "sims_SE-Est_change.png"), width = 6, height = 4)
