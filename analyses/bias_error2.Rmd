...
*t0 values do not reflect original regressions. - bootMed estimates are close but in some casese fall far outside of constructed confidence intervals. Find a straightforward & parsimonious way to display coefficient estimates and bootstrapped CIs*  
