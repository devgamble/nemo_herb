...
```{r}
#Create Subsets for BB & HA
df2_BB <- nemo_df2 %>% 
  filter(lat <= 38.8186 & lat > 37.8186) %>% 
  filter(long <= -122.5718 & long > -123.5718)
...
#sample 1901-2018 MAT
df2_BB %>% 
  filter(specimen_number == "SEINET7067240") %>% 
  select(MAT_100Y)
#MAP
df2_BB %>% 
  filter(specimen_number == "SEINET7067240") %>% 
...
#HA
df2_HA <- nemo_df2 %>% 
  filter(lat <= 36.8792 & lat > 35.8792) %>% 
  filter(long <= -121.0629 & long > -122.0629)
...
#sample 1901-2018 MAT
df2_HA %>% 
  filter(specimen_number == "PGM1065") %>% 
  select(MAT_100Y)
#MAP
df2_HA %>% 
  filter(specimen_number == "PGM1065") %>% 
