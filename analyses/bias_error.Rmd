...
plot_summs(M100Y_lm1A, er_an0A, er_an1A, er_an2A, model.names = c("Original", "all errors", "0-5 km", "0-2 km"), scale = TRUE) + theme_bw()
...
plot_summs(M100Y_lm2A, erc_an0A, erc_an1A, erc_an2A, model.names = c("Original", "All errors", "0-5 km", "0-2 km"), scale = TRUE) + theme_bw()
ggsave(here::here("analyses", "figs1", "error_d_subset_MAT-MAP2A.png"), width = 6, height = 4)
summary(M100Y_lm2A)
...
plot_summs(M100Y_lm1AL, er_an0AL, er_an1AL, er_an2AL, model.names = c("Original", "all errors", "0-5 km", "0-2 km"), scale = TRUE) + theme_bw()
...
plot_summs(M100Y_lm2AL, erc_an0AL, erc_an1AL, erc_an2AL, model.names = c("Original", "All errors", "0-5 km", "0-2 km"), scale = TRUE) + theme_bw()
...
corrplot(cor(nemo_df2 %>% select(MAT_100Y, MAP_100Y, MAT_A, MAP_A, elev_m, long, year))) #some autocorrelation in T anoms? elev*long corr
...
plot_summs(Wt100Y_lm1i, er_wt0i, er_wt1i, er_wt2i, model.names = c("Original", "All errors", "0-5 km", "0-2 km"), scale = TRUE) +
  theme_bw()
...
plot_summs(Wt100Y_lm1AL, er_wt0AL, er_wt1AL, er_wt2AL, model.names = c("Original", "All errors", "0-5 km", "0-2 km"), scale = TRUE) + theme_bw()
...
plot_summs(Wt100Y_lm1iAL, er_wt0iAL, er_wt1iAL, er_wt2iAL, model.names = c("Original", "All errors", "0-5 km", "0-2 km"), scale = TRUE) +
  theme_bw()
...
plot_summs(Wt100Y_lm1iAL2, er_wt0iAL2, er_wt1iAL2, er_wt2iAL2, model.names = c("Original", "All errors", "0-5 km", "0-2 km"), scale = TRUE) +
  theme_bw()
#ggsave(here::here("analyses", "figs1", "error_d_subset_Wt1ALi.png"), width = 6, height = 4)
...
plot_summs(Wt100Y_lm2AL, erc_wt0AL, erc_wt1AL, erc_wt2AL, model.names = c("OG", "all errors", "0-5 km", "0-2 km"), scale = TRUE) + theme_bw()
...
plot_summs(Sp100Y_lm1AL, er_sp0AL, er_sp1AL, er_sp2AL, model.names = c("Original", "All errors", "0-5 km", "0-2 km"), scale = TRUE) + theme_bw()
#ggsave(here::here("analyses", "figs1", "error_d_subset_Sp1.png"), width = 6, height = 4)
...
plot_summs(Sp100Y_lm1iAL, er_sp0iAL, er_sp1iAL, er_sp2iAL, model.names = c("Original", "All errors", "0-5 km", "0-2 km"), scale = TRUE) +
  theme_bw()
#ggsave(here::here("analyses", "figs1", "error_d_subset_Wt1ALi.png"), width = 6, height = 4)
...
plot_summs(Sp100Y_lm1iAL2, er_sp0iAL2, er_sp1iAL2, er_sp2iAL2, model.names = c("Original", "All errors", "0-5 km", "0-2 km"), scale = TRUE) +
  theme_bw()
#ggsave(here::here("analyses", "figs1", "error_d_subset_Wt1ALi.png"), width = 6, height = 4)
...
plot_summs(Sp100Y_lm2AL, erc_sp0AL, erc_sp1AL, erc_sp2AL, model.names = c("Original", "All errors", "0-5 km", "0-2 km"), scale = TRUE) + theme_bw()
#ggsave(here::here("analyses", "figs1", "error_d_subset_Sp2.png"), width = 6, height = 4)
...
plot_summs(M100Y_lm1, M100Y_lm3a, M100Y_lm3b, model.names = c("Original", "numeric", "factor-bins"), scale = TRUE) + theme_bw()
...
plot_summs(M100Y_lm1A, M100Y_lm3aA, M100Y_lm3bA, model.names = c("Original", "numeric", "factor-bins"), scale = TRUE) + theme_bw()
#ggsave(here::here("analyses", "figs1", "error_covar_plotsumms_MAT-MAP1.png"), width = 6, height = 4)
...
plot_summs(M100Y_lm2AL, M100Y_lm4aAL, M100Y_lm4bAL, model.names = c("Original", "numeric", "factor/bin"), scale = TRUE) + theme_bw()
...
plot_summs(Wt100Y_lm1, Wt100Y_lm3a, Wt100Y_lm3b, model.names = c("Original", "numeric", "factor-bins"), scale = TRUE) + theme_bw()
...
plot_summs(Sp100Y_lm1, Sp100Y_lm3a, Sp100Y_lm3b, model.names = c("Original", "numeric", "factor-bins"), scale = TRUE) + theme_bw()
...
plot_summs(Sp100Y_lm1i, Sp100Y_lm3ai, Sp100Y_lm3bi, model.names = c("Original", "numeric", "factor-bins"), scale = TRUE) + theme_bw()
...
plot_summs(collb_lm1, collb_lm2, model.names = c("Original", "No top collectors"), scale = TRUE) + theme_bw()
