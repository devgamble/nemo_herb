...
```{r}
sens_int_lm1 <- lm(DOY ~ MAT_A*MAT_100Y + MAT_A*MAP_100Y + elev_m + lat + long + year, data = nemo_df2)
...
sslm1 <- sim_slopes(sens_int_lm1, pred = "MAT_A", modx = "MAT_100Y")
sslm1
plot(sslm1)

sslm2a <- sim_slopes(sens_int_lm2, pred = "MAP_A", modx = "MAT_100Y")
sslm2a
plot(sslm2a)

sslm2b <- sim_slopes(sens_int_lm2, pred = "MAP_A", modx = "MAP_100Y")
sslm2b
plot(sslm2b)
...
interact_plot(sens_int_lm1, pred = "MAT_A", modx = "MAT_100Y", x.label = "MAT (anomaly)", legend.main = "MAT (1901-2000)", linearity.check = TRUE)
interact_plot(sens_int_lm2, pred = "MAP_A", modx = "MAT_100Y", x.label = "MAT (anomaly)", legend.main = "MAT (1901-2000)", linearity.check = TRUE)
interact_plot(sens_int_lm2, pred = "MAP_A", modx = "MAP_100Y", x.label = "MAT (anomaly)", legend.main = "MAT (1901-2000)", linearity.check = TRUE)
...
#MAT_100Y * MAT_A
interact_plot(sens_int_lm1, pred = "MAT_A", modx = "MAT_100Y", x.label = "MAT (anomaly)", legend.main = "MAT (1901-2000)") + theme_apa() +
...
#MAP_100Y * MAT_A
interact_plot(sens_int_lm2, pred = "MAP_A", modx = "MAT_100Y", x.label = "MAP (anomaly)", legend.main = "MAT (1901-2000)") + theme_apa() + theme(legend.title = element_text("MAT (1901-2000)")) +
geom_vline(xintercept = 0, lty = 2, col = "#808080")
...
```{r}
#plot_model(sens_int_lm1, type = "pred", terms = c("MAT_100Y", "MAT_A"))
