...
visreg(lm1, xvar = "long", xlab = "Longitude", points = list(col = "#404040"))
visreg(lm1.1, xvar = "lat", xlab = "Latitude", points = list(col = "#404040"))
...
summary(map_t1.1)
visreg(map_t1.1, xvar = "year", points = list(col = "#404040")) #Not sure how to hide line without gg=TRUE...
...
PPsp_t1  <- lm(PPT_sp_Y ~ year + elev_m + long + Tmin_sp_100Y, data = nemo_df2)
summary(PPsp_t1)
...
```{r warning = FALSE, message = FALSE, echo = FALSE}
#Anomalies
map_t2 <- lm(MAP_A ~ year + elev_m + long + MAT_100Y + MAP_Y, data = nemo_df2) #YoC & anom correlated (r = .45), include?
summary(map_t2)
