...
See 'EDA1.Rmd' for exploration of variables from the georferenced herbarium records and 'EDA_climate.Rmd' for ClimateNA variables.  
...
summ(lm1, vif = TRUE) #VIF for long, elev, MAP, MAT is high
...
visreg(mat_t1.3, xvar = "year", points = list(col = "#404040"))
...
MAT (YoC) has warmed about 1.3 degrees over about 120 years
...
```{r message = FALSE, warning = FALSE, echo = FALSE}
#MAT Anomalies
mat_t2 <- lm(MAT_A ~ year + elev_m + long, data = nemo_df2) #No effect of MAP_A
summary(mat_t2)

visreg(mat_t2, xvar = "year", points = list(col = "#404040"), gg = TRUE) + 
