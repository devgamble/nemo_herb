...
Split by climate regions, geography, other?  
...
summary(mat_t1)
visreg(mat_t1,points = list(col = "#404040"))

#Control for geography (and PI) - use this model
mat_t1.1 <- lm(MAT_Y ~ year + elev_m + long, data = nemo_df2)
summary(mat_t1.1)
visreg(mat_t1.1, xvar = "year", points = list(col = "#404040"))


mat_t1.3 <- lm(MAT_Y ~ year + elev_m + long, data = nemo_e0_5)
#summary(mat_t1.3)  #0 - 5 km: lower R2, greater SE

#Compare model estimates
plot_summs(mat_t1, mat_t1.1, mat_t1.3, scale = TRUE)
...
```{r message = FALSE, warning = FALSE, echo = FALSE}
#MAT Anomalies
mat_t2 <- lm(MAT_A ~ year + elev_m + long, data = nemo_df2)
summary(mat_t2)
...
plot_summs(an_lm_e, an_lm_g1.2, model.names = c("Herb geo", "Geo"), scale = TRUE)

plot_summs(an_lm_ec, an_lm_g1.3, model.names = c("Herb geo", "Geo"), scale = TRUE)
