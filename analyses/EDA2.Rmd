...
#Normals & Anomalies - Seasonal
corrplot(cor(nemo_df2 %>% select(Tmin_wt_100Y, Tmax_wt_100Y, Tmin_sp_100Y, Tmax_sp_100Y, PPT_wt_100Y, PPT_sp_100Y, Tmin_wt_A, Tmax_wt_A, Tmin_sp_A, Tmax_sp_A, PPT_wt_A, PPT_sp_A)), method = "color", addCoef.col = "black", type = "upper", number.cex = .7,)
