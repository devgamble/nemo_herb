...
- Combines specimen data from `nemo_all_2.csv` (with error distance) and climate data from `climNA_nemo_all.csv`, filtering for years only from 1901-2019. Use `nemo_full_1861_2019.csv` for full temporal breadth.
Update (08/13/2021): PPT variables no longer log-transformed in this csv!
...
- `EDA2.Rmd`
  ...
  + First writing of the complete `nemo_full_1901_2019.csv` and `nemo_full_1861_2019.csv' (PPT variables no longer log-transformed)   
